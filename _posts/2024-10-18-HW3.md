...
---
**PyTorch with Smoothly Clipped Absolute Deviations (SCAD)**
...
def analyze_feature_importance(scad_model, feature_names):
    ...
    print("SCAD Coefficients:", coefficients)  # Print coefficients to check
...
# Visualize feature importance if there are selected features
...
# Run feature importance analysis after training SCAD
...
Best Alpha for SqrtLasso: 0.01, MSE: 1414.251638621219
...
plt.show()
```
![FeatureImportanceBasedonSCADCoefficients2]({{ site.baseurl }}/assets/images/Feature2.png)
...
Coefficient MSE: 0.7635819991995422

![betastar1]({{ site.baseurl }}/assets/betastar1.png)
