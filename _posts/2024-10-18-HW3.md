...
Smoothly Clipped Absolute Deviation (SCAD) is a non-concave penalty function [Fan and Li (2001)](https://fan.princeton.edu/sites/g/files/toruqf5476/files/documents/penlike.pdf). It aims to solve variable selection bias problem that comes from other methods such as LASSO regression. 
